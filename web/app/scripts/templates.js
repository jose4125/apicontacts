...
((__t = ( first_name )) == null ? '' : __t) +
'">\n              </div>\n              <div class="form-group col-md-6">\n                <input type="tsxt" class="form-control" id="last_name" placeholder="Last Name" value="' +
((__t = ( last_name )) == null ? '' : __t) +
'">\n              </div>\n              <div class="form-group col-md-6">\n                <input type="text" class="form-control" id="indentification" placeholder="Identification number" value="' +
((__t = ( identification )) == null ? '' : __t) +
'">\n              </div>\n              <div class="form-group col-md-6">\n                <input type="text" class="form-control" id="cel" placeholder="Cel Phone" value="' +
((__t = ( cel )) == null ? '' : __t) +
'">\n              </div>\n              <div class="form-group col-md-6">\n                <input type="text" class="form-control" id="phone_eme" placeholder="Emergency Phone" value="' +
((__t = ( phone_eme )) == null ? '' : __t) +
'">\n              </div>\n              <div class="form-group col-md-6">\n                <input type="email" class="form-control" id="rkr_mail" placeholder="Rokk3r Mail" value="' +
((__t = ( rkr_mail )) == null ? '' : __t) +
'">\n              </div>\n              <div class="form-group col-md-6">\n                <input type="email" class="form-control" id="user_mail" placeholder="Personal Mail" value="' +
((__t = ( user_mail )) == null ? '' : __t) +
'">\n              </div>\n              <div class="form-group col-md-6">\n                <input type="text" class="form-control" id="skype" placeholder="Skype" value="' +
((__t = ( skype )) == null ? '' : __t) +
'">\n              </div>\n              <div class="form-group col-md-6">\n                <input type="text" class="form-control" id="birthday" placeholder="Birthday" value="' +
((__t = ( birthday )) == null ? '' : __t) +
'">\n              </div>\n            </form>\n\n        \t</div>\n        \t<div class="modal-footer">\n          \t\t<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>\n          \t\t<button id="btnAdd" type="button" class="btn btn-success">Add Contact</button>\n        \t</div>\n      \t</div><!-- /.modal-content -->\n    </div><!-- /.modal-dialog -->\n\n\n';
